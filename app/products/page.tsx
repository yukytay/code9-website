...
const watches = [
  ...
  { sku:"DW004", id:"elan-36-watch", zhTitle:"数悦时光", title:"Élan 36", size:"36 mm", zh:"寓意数字平衡、阴阳协调、生活顺遂；璀璨表圈象征光芒、圆满与财富循环，亦代表丰盛、成就与财气生辉。提升财运、汇聚财富机遇、贵人相助、事业增长、聚财守财。", desc:"A symbolic timepiece inspired by wealth, balance and continuous growth. Enhanced wealth opportunities, steady financial growth, successful career development and lasting prosperity.", blessing:"Balance your path. Seize opportunities. Let prosperity grow with time.", images:["/products/watches/dw004-elan-36-temporary.jpeg"] },
];
