...
const bracelets = [
  { sku:"DB001", id:"destiny-numbers-bracelet", zhTitle:"数运随行", title:"Destiny Numbers", zh:"数有所寓，运有所随；吉数相连，福运相伴。", desc:"Symbolizing personal strengths, balance, blessings and good fortune.", images:["/products/bracelets/DB001-Destiny-Numbers-Final.png","/products/bracelets/DB001-Destiny-Numbers-Final-02.png"] },
